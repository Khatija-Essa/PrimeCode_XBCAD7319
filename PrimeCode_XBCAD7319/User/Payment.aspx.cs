...
namespace PrimeCode_XBCAD7319.User
{
    public partial class Payment : System.Web.UI.Page
    {
        ...
        {
            StripeConfiguration.ApiKey = "sk_test_26PHem9AhJZvU623DfE1x4sd"; //stripe api key 
                ...
                LineItems = new List<SessionLineItemOptions>
        {
            new SessionLineItemOptions
            {
                ...
                Mode = "payment",
                SuccessUrl = "http://localhost:50630/User/PaymentSuccess.aspx?session_id={CHECKOUT_SESSION_ID}",//redirect to after payment is made
            ...
            // Save session details and plan to the database
            SavePaymentSession(username, plan, session.Id);
        ...
        //saves the information to the databse 
        private void SavePaymentSession(string username, string plan, string sessionId)
        {
            ...
            {
                string query = @"INSERT INTO PaymentSessions (Username, [Plan], SessionId, CreatedAt) 
                                 VALUES (@Username, @Plan, @SessionId, @CreatedAt)";
