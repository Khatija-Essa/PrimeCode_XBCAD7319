<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="JobList.aspx.cs" Inherits="PrimeCode_XBCAD7319.Admin.JobList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex justify-content-end">
        <asp:HyperLink ID="linkback" runat="server" NavigateUrl="~/Admin/Resume.aspx" CssClass="btn-gray" Visible="false">
            Back
        </asp:HyperLink>
    </div>
</div>
